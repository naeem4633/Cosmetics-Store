    ...
    <section className='w-full relative tracking-wide min-h-[80vh] flex justify-center items-center'>
      <form onSubmit={handleSubmit} className="authorization-form">
        ...
        <div className="authorization-inputForm">
          ...
          <input type="email" id="email" name="email" className="authorization-input" value={formData.email} onChange={handleChange} placeholder="Enter your Email"/>
        </div>
        ...
        <div className="authorization-inputForm">
          ...
          <input type="password" id="password" name="password" className="authorization-input" value={formData.password} onChange={handleChange} placeholder="Enter your Password"/>
          ...
          <div className="authorization-flex-row justify-center items-center">
            <div className='flex authorization-flex-row'>
              <input className='accent-[#c82f7e]' type="checkbox"/>
              <label>Remember me </label>
            </div>
          </div>
          <button className="authorization-button-submit transition-all duration-200">Sign In</button>
          ...
          <div className='flex flex-col'>
            ...
            <div className="authorization-flex-row">
              ...
              <button className="authorization-btn apple">
