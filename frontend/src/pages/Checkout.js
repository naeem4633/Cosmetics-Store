...
const Checkout = ({savedItems, onChange}) => {
  ...
  return (
    <section className='w-full relative flex flex-col tracking-wide mt-16'>
        <div className='mx-auto w-4/5 flex flex-row tracking-wide p-2 justify-between'>
            <div className='w-1/2 flex flex-col space-y-2 p-4'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col space-y-4'>
                    ...
                    <div className='mx-auto w-1/2 flex py-2 items-center space-x-2'>
                    ...
                    <div className='w-3/4 mx-auto flex flex-row justify-center space-x-4'>
                    ...
                    <input className='w-1/2 mx-auto p-3 focus:outline-[#c82f7e] rounded border border-gray-300' type='text' name='cardholderName' value={formData.cardholderName} onChange={handleChange} placeholder='Cardholder Name'/>
            ...
            <div className='w-1/2 flex flex-row items-center justify-center'>
                <div className='mx-auto w-3/4 flex flex-col space-y-2 border-2 border-[#c82f7e] drop-shadow-sm'>
                    ...
                    <div className='h-[50vh] flex flex-col overflow-y-scroll scrollbar-thin scrollbar-thumb-[#c82f7e] px-10'>
                    {cartItems.map((item) => (
                    <>
